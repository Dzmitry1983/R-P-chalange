...
class CommentServerModelTest: XCTestCase {
    private typealias TestableObject = CommentServerModel
    ...
    override func setUp() {
		...
		self.testObject.commentInfo = self.defaultValue
    }
	...
	func testEquatable() {
		...
		copyOfTestObject.commentInfo["Key1"] = ""
		copyOfTestEmptyObject.commentInfo = ["test":""]
